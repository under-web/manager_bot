...
def run_bot():
    ...
    def send_markup(message):
        ...
        # TODO:дописать функционал бота ответы на каждый вопрос
        # TODO:ответы могут быть ключами к словарю в котором лежит стоимость кадой подуслуги а в конце сумма(?)
